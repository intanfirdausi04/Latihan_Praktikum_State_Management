...
class SelectCountry extends Equatable {
...
class UniversityBloc extends Bloc<SelectCountry, UniversityState> {
  UniversityBloc() : super(UniversityState([]));

  @override
  Stream<UniversityState> mapEventToState(SelectCountry event) async* {
    final universities = (String countryName) async {
      // Implementasi fungsi yang sama seperti sebelumnya
    }(event.country.name);
    yield UniversityState(universities as List<University>);
  }
}
...
class _UniversityListState extends State<UniversityList> {
  ...
  // Deklarasikan variabel aseanCountries
        ...
        children: [
          BlocBuilder<UniversityBloc, UniversityState>(
            builder: (context, state) {
              return DropdownButton<AseanCountry>(
                hint: const Text('Pilih Negara ASEAN'),
                ...
                onChanged: (selectedCountry) {
                  ...
                  if (selectedCountry != null) {
                    BlocProvider.of<UniversityBloc>(context)
                        .add(SelectCountry(selectedCountry));
                  }
                },
