...
class AseanCountryProvider with ChangeNotifier {
  List<AseanCountry> _aseanCountries = [
  ...
  List<AseanCountry> get aseanCountries => _aseanCountries;
  ...
  List<University> getUniversitiesByCountry(String countryName) {
    switch (countryName) {
      ...
      case "Malaysia":
        return [
          University(
              name: "Universiti Malaya", webPage: "https://www.um.edu.my"),
          University(
          ...
          University(
              ...
              webPage: "https://www.ipb.ac.id"),
          University(
              name: "Universitas Airlangga",
              webPage: "https://www.unair.ac.id"),
          University(
          ...
          University(
              ...
              webPage: "https://www.undip.ac.id"),
          University(
              name: "Universitas Hasanuddin",
              webPage: "https://www.unhas.ac.id")
        ];
      case "Singapura":
        return [
          University(
      ...
      case "Filipina":
        return [
          ...
          University(
              ...
              webPage: "https://www.adamson.edu.ph"),
          University(
              name: "Far Eastern University",
              webPage: "https://www.feu.edu.ph"),
          University(
      ...
      case "Vietnam":
        return [
          ...
          University(
              name: "University of Danang", webPage: "https://www.udn.vn"),
          University(
    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        primaryColor: Color.fromARGB(
            255, 2, 137, 221), // Mengubah warna aksen menjadi amber
        scaffoldBackgroundColor: Color.fromARGB(255, 225, 225, 227),
        colorScheme: ColorScheme.fromSwatch().copyWith(
            secondary: Color.fromARGB(
                255, 105, 106, 107)), // Warna latar belakang scaffold
      ),
      home: MultiProvider(
        providers: [
          ChangeNotifierProvider(create: (_) => UniversityProvider()),
          ChangeNotifierProvider(create: (_) => AseanCountryProvider()),
        ],
...
class _UniversityListState extends State<UniversityList> {
  ...
  Widget build(BuildContext context) {
    ...
    Provider.of<AseanCountryProvider>(context);
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor:
            Theme.of(context).primaryColor, // Warna latar belakang AppBar
      ),
      body: Column(
        children: [
          Consumer<AseanCountryProvider>(
            builder: (context, aseanCountryProvider, child) {
              return DropdownButton(
                ...
                onChanged: (selectedCountry) {
                  ...
                  if (selectedCountry != null) {
                    List<University> universitiesToShow = aseanCountryProvider
                        .getUniversitiesByCountry(selectedCountry.name);

                    universityProvider.setUniversities(universitiesToShow);
                  }
                },
                items: aseanCountryProvider.aseanCountries
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return ListTile(
                      ...
                      subtitle: InkWell(
                        // Ganti ke InkWell agar bisa di-tap
                        onTap: () {
